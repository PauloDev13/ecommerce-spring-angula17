...
import { ProductRequestInterface } from '../../models/ProductRequestInterface';
...
export class AdminService {
  ...
  private categories$(): Observable<CategoryResponseInterface[]> {
  ...
  createProduct$(product: ProductRequestInterface) {
